...
public class UnionOfLinkedList {
	...
	public static void main(String[] args) {
		...
		UnionOperation union = new UnionOperation(list1.Head, list2.Head);
		union.print();
...
class UnionOperation	{
	...
	public UnionOperation(Node Head1, Node Head2)	{	
	...
	public void intersectionOperation(Node Head1,Node Head2)	{
		Node node1 = Head1;
		Node node2 = Head2;
